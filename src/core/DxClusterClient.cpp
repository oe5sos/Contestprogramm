...
void DxClusterClient::onDisconnected()
{
    ...
    if (!m_intentionalDisconnect) {
        // Same exponential-backoff shape as On4kstClient::onDisconnected
        // (itself carried over from this class's own NereusSDR
        // original) -- shift count clamped to avoid signed-int UB.
